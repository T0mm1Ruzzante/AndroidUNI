...
class Activity2: ComponentActivity()
{
    ...
    override fun onStart() {
        super.onStart()
        Log.v(mTag, "onStart CHIAMATO")
    }

    override fun onRestart() {
            super.onRestart()
        Log.v(mTag, "onRestart CHIAMATO")
    }

    override fun onPause() {
        super.onPause()
        Log.v(mTag, "onPause CHIAMATO")
    }

    override fun onResume() {
        super.onResume()
        Log.v(mTag, "onResume CHIAMATO")
    }

    override fun onStop() {
        super.onStop()
        Log.v(mTag, "onStop CHIAMATO")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.v(mTag, "onDestroy CHIAMATO")
    }

    override fun onSaveInstanceState(outState: Bundle) {
        super.onSaveInstanceState(outState)
        Log.v(mTag, "onSaveInstanceState CHIAMATO")
    }
}
